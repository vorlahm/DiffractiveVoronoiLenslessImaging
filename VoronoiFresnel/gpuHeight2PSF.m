function PSFspec = gpuHeight2PSF(t, wavelengths, indices, p_doe, z, nbin, padM, padN)
%GPUHEIGHT2PSF computes spectral PSFs from the height map t.
%
%   PSFSPEC = GPUHEIGHT2PSF(T, WAVELENGTHS, INDICES, P_DOE, Z, NBIN, PADM, 
...
%
%   This is the GPU version of the Height2PSF function.
%
%   author: Qiang Fu
